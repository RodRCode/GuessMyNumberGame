...
Write a console application implementing the bisection algorithm. As input, have the user select a number from 1 to 10. Use appropriate exception handling to guard against invalid input from the user.
